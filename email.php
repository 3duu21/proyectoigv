...
try {
        ...
        $mail->SMTPSecure = "tls";
        $mail->Port = 587;
        $mail->Username = 'mlgcombustible@gmail.com';
        $mail->Password = 'wqtzgribyzqlkvet';
    
        $mail->setFrom('mlgcombustible@gmail.com', ' Nos Han Contactado!');
        $mail->addAddress('mlgcombustible@gmail.com');
        ...
        $mail->Subject = 'Contacto Inversiones Gran Via';
        $mail->Body ="
        <html>
        <style>
